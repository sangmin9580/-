...
class PetNavigationScreen extends ConsumerStatefulWidget {
  ...
  static const routeURL = '/petnavigation';
  static const routeName = 'petnavigation';
...
class _PetNavigationScreenState extends ConsumerState<PetNavigationScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final petListState = ref.watch(petNavigationProvider);
    return petListState.when(
      data: (data) {
        return WillPopScope(
          onWillPop: () async {
